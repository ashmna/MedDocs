...
<!-- Mirrored from jesus.gallery/cloud2/graphs.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Aug 2015 12:10:55 GMT -->
<head>
		<meta charset="UTF-8" />
	...
	<body>
			...
			<div class="main-container">
				...
				<div class="top-bar clearfix">
					<div class="page-title">
						<h4><div class="fs1" aria-hidden="true" data-icon="&#xe0f8;"></div>Graphs <a href="maps.html" class="samll">Maps</a></h4>
					</div>
								...
								<div class="panel panel-green">
									...
									<div class="panel-body">
										<div id="example-section28">
											<div id="flotcontainer" class="chart-height"></div>

											<div class="pull-left">
												<label class="radio-inline">
													<input type="radio" id="chartType1" name="ct" value="line" checked> Line
												</label>
												<label class="radio-inline">
													<input type="radio" id="chartType2" name="ct" value="bar"> Bar
												</label>
											</div>

											<div class="pull-right">
												<label class="checkbox-inline">
													<input type="checkbox" id="cbdata1"> Likes
												</label>
												<label class="checkbox-inline">
													<input type="checkbox" id="cbdata2" checked> Shares
												</label>
												<label class="checkbox-inline">
													<input type="checkbox" id="cbdata3" checked> Comments
												</label>
											</div>
										</div>
									</div>
						...
						<div class="row no-gutter">
							<div class="col-md-6 col-sm-6 col-sx-12">
								<div class="panel panel-pink">
									...
									<div class="panel-body">
										<div id="crosshair" class="chart-height"></div>
									</div>
								</div>
							</div>
							<div class="col-md-6 col-sm-6 col-sx-12">
						...
						<div class="row no-gutter">
							<div class="col-md-6 col-sm-6 col-sx-12">
								<div class="panel panel-yellow">
									...
									<div class="panel-body">
										<div id="combineChartCompare" class="chart-height"></div>
									</div>
								</div>
							</div>
							<div class="col-md-6 col-sm-6 col-sx-12">
								<div class="panel panel-red">
									...
									<div class="panel-body">
										<div id="rectPieChart" class="chart-height"></div>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row no-gutter">
							<div class="col-md-4 col-sm-4 col-sx-12">
								<div class="panel panel-fb">
									...
									<div class="panel-body">
										<div id="pieHover"></div>
										<div id="simplePieChart" class="chart-height"></div>
									</div>
								</div>
							</div>
							<div class="col-md-4 col-sm-4 col-sx-12">
						...
						<div class="row no-gutter">
							...
							<div class="col-md-6 col-sm-6 col-sx-12">
								<div class="panel panel-blue">
									...
									<div class="panel-body">
										<div id="verticalBar" class="chart-height"></div> 
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row no-gutter">
							<div class="col-md-6 col-sm-6 col-sx-12">
								<div class="panel panel-pink">
									...
									<div class="panel-body">
										<div id="horizontalBar" class="chart-height"></div>
									</div>
								</div>
							</div>
							<div class="col-md-6 col-sm-6 col-sx-12">
		...
		<!-- Custom flot JS -->
		<script src="js/flot/custom/crosshair.js"></script>
		<script src="js/flot/custom/toggle-series.js"></script>
		<script src="js/flot/custom/combine-chart.js"></script>
		<script src="js/flot/custom/combine-chart-compare.js"></script>
		<script src="js/flot/custom/interactive-pie-chart.js"></script>
		<script src="js/flot/custom/donut-pie-chart.js"></script>
		<script src="js/flot/custom/pie-hide-label.js"></script>
		<script src="js/flot/custom/rectangular-pie.js"></script>
		<script src="js/flot/custom/stacked-bar-chart.js"></script>
		<script src="js/flot/custom/vertical-bar.js"></script>
		<script src="js/flot/custom/horizontal-bar.js"></script>
		<script src="js/flot/custom/area-chart.js"></script>
...
<!-- Mirrored from jesus.gallery/cloud2/graphs.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Aug 2015 12:11:03 GMT -->
</html>