...
<!-- Mirrored from jesus.gallery/cloud2/form.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Aug 2015 12:11:03 GMT -->
<head>
    <meta charset="UTF-8"/>
            ...
            <div class="spacer-xs">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
			                    ...
			                    <span class="input-group-btn">
			                      <button class="btn btn-default" type="button" data-original-title="" title="">Go!
                                  </button>
			                    </span>
                                            <input type="text" class="form-control">
                                        </div>
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-sx-6">
                                        <div class="input-group">
                                            <input type="text" class="form-control">
			                    <span class="input-group-btn">
			                      <button class="btn btn-default" type="button" data-original-title="" title="">
                                      Submit!
                                  </button>
			                    </span>
                                        </div>
                ...
                <div class="row no-gutter">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4>Check Boxes &amp; Radio Addons</h4>
                                <ul class="links">
                                    <li>
                                        <a href="#">
                                            <i class="fa fa-list"></i>
