...
<!-- Mirrored from jesus.gallery/cloud2/maps.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Aug 2015 12:11:53 GMT -->
<head>
		<meta charset="UTF-8" />
			...
			<div class="main-container">
				...
				<div class="top-bar clearfix">
					<div class="page-title">
						<h4><div class="fs1" aria-hidden="true" data-icon="&#xe089;"></div>Maps <a href="graphs.html" class="samll">Graphs</a></h4>
					</div>
    ...
    <script src="js/jqvmap/maps/jquery.vmap.russia.js"></script>
    <script src="js/jqvmap/maps/jquery.vmap.usa.js"></script>
    <script src="js/jqvmap/maps/jquery.vmap.world.js"></script>
    <script src="js/jqvmap/maps/jquery.vmap.germany.js"></script>
...
<!-- Mirrored from jesus.gallery/cloud2/maps.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Aug 2015 12:12:17 GMT -->
</html>