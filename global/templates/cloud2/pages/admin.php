		...
		<aside id="sidebar">
			...
			<!-- Logo starts -->
			<a href="#" class="logo">
				<img src="/global/img/logo.png" alt="logo">
			</a>
			<!-- Logo ends -->
					...
					<ul id="mini-nav" class="clearfix">
						<li class="list-box hidden-xs">
							...
							<ul class="dropdown-menu flipInX animated messages">
								...
								<li>
									<div class="icon">
										<img src="/global/img/admin10.png" alt="Browser">
									</div>
									<div class="details">
								...
								<li>
									<div class="icon">
										<img src="/global/img/admin6.png" alt="Browser">
									</div>
									<div class="details">
								...
								<li>
									<div class="icon">
										<img src="/global/img/admin3.png" alt="Browser">
									</div>
									<div class="details">
        ...
        <section class="user-profile">
          <div class="profile-container">
            <img src="/global/img/admin1.png" class="user-img" alt="User Image">
            <div class="desc">
              <h4>John Doe</h4>
          ...
          <ul class="cart">
            <li class="cart-item">
              <span class="cart-item-pic">
                <img src="/global/img/admin2.png" alt="EarthSquare">
              </span>
              Item #1
            ...
            <li class="cart-item">
              <span class="cart-item-pic">
                <img src="/global/img/admin4.png" alt="EarthSquare">
              </span>
              Item #2
              <span class="cart-item-desc">Description</span>
            ...
            <li class="cart-item">
              <span class="cart-item-pic">
                <img src="/global/img/admin8.png" alt="EarthSquare">
              </span>
              Item #3
              <span class="cart-item-desc">Description</span>
			...
			<div class="main-container">
				...
				<div class="top-bar clearfix">
					<div class="page-title">
						<h4><div class="fs1" aria-hidden="true" data-icon="&#xe007;"></div>Dashboard <a href="#" class="samll">Breadcrumb</a></h4>
					</div>
							...
							<div class="col-md-4 col-sm-6 col-sx-12">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<ul class="chat">
											<li class="in">
												<img class="avatar" alt="" src="/global/img/admin11.png">
												<div class="message">
													<span class="arrow">
													</span>
													<a href="#" class="name">
											...
											<li class="out">
												<img class="avatar" alt="" src="/global/img/admin8.png">
												<div class="message">
													<span class="arrow">
													</span>
													<a href="#" class="name">
											...
											<li class="in">
												<img class="avatar" alt="" src="/global/img/admin5.png">
												<div class="message">
													<span class="arrow">
													</span>
													<a href="#" class="name">
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<div class="tweets-container">
											...
											<div class="tweet-box">
												<img class="avatar" alt="" src="/global/img/admin2.png">
												<div class="tweet">
													<p>
											...
											<div class="tweet-box">
												<img class="avatar" alt="" src="/global/img/admin1.png">
												<div class="tweet">
													<p>
											...
											<div class="tweet-box no-margin">
												<img class="avatar" alt="" src="/global/img/admin3.png">
												<div class="tweet">
													<p>
												...
												<ul class="signups">
													<li>
														<div class="user pull-left">
															<img src="/global/img/admin2.png" alt="user" >
														</div>
														<div class="info">
															<h6>Sandy</h6>
													...
													<li>
														<div class="user pull-left">
															<img src="/global/img/admin1.png" alt="user" >
														</div>
														<div class="info">
															<h6>Srinu Basava</h6>
													...
													<li>
														<div class="user pull-left">
															<img src="/global/img/admin8.png" alt="user" >
														</div>
														<div class="info">
															<h6>Honey</h6>
													...
													<li>
														<div class="user pull-left">
															<img src="/global/img/admin9.png" alt="user" >
														</div>
														<div class="info">
															<h6>Rahul Dravid</h6>
