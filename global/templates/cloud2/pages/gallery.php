...
<!-- Mirrored from jesus.gallery/cloud2/gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Aug 2015 12:11:06 GMT -->
<head>
		<meta charset="UTF-8" />
			...
			<div class="main-container">
				...
				<div class="top-bar clearfix">
					<div class="page-title">
						<h4><div class="fs1" aria-hidden="true" data-icon="&#xe0e6;"></div>Gallery</h4>
					</div>
										...
										<div class="baguetteBoxThree gallery">
											<div class="row">
												<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
													<a href="img/img-lg-one.jpg">
														<img src="img/img-lg-one.jpg" class="img-responsive" alt="Navigator Admin">
													</a>
												</div>
												<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
													<a href="img/img-lg-two.jpg">
														<img src="img/img-lg-two.jpg" class="img-responsive" alt="Navigator Admin">
													</a>
												</div>
												<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
													<a href="img/img-lg-three.jpg">
														<img src="img/img-lg-three.jpg" class="img-responsive" alt="Navigator Admin">
													</a>
												</div>
												<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
													<a href="img/img-lg-four.jpg">
														<img src="img/img-lg-four.jpg" class="img-responsive" alt="Navigator Admin">
													</a>
												</div>
												<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
													<a href="img/img-lg-five.jpg">
														<img src="img/img-lg-five.jpg" class="img-responsive" alt="Navigator Admin">
													</a>
												</div>
												<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
													<a href="img/img-lg-six.jpg">
														<img src="img/img-lg-six.jpg" class="img-responsive" alt="Navigator Admin">
													</a>
												</div>
												<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
													<a href="img/img-lg-seven.jpg">
														<img src="img/img-lg-seven.jpg" class="img-responsive" alt="Navigator Admin">
													</a>
												</div>
												<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
													<a href="img/img-lg-eight.jpg">
														<img src="img/img-lg-eight.jpg" class="img-responsive" alt="Navigator Admin">
													</a>
												</div>
												<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
													<a href="img/img-lg-nine.jpg">
														<img src="img/img-lg-nine.jpg" class="img-responsive" alt="Navigator Admin">
													</a>
												</div>
												<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
													<a href="img/img-lg-ten.jpg">
														<img src="img/img-lg-ten.jpg" class="img-responsive" alt="Navigator Admin">
													</a>
												</div>
												<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
													<a href="img/img-lg-eleven.jpg">
														<img src="img/img-lg-eleven.jpg" class="img-responsive" alt="Navigator Admin">
													</a>
												</div>
												<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
													<a href="img/img-lg-twelve.jpg">
														<img src="img/img-lg-twelve.jpg" class="img-responsive" alt="Navigator Admin">
													</a>
												</div>
											</div>
										</div>
									...
									<div class="panel-body">
										...
										<div class="row">
											<div class="col-md-2 col-sm-2 col-xs-4">
												<a href="#" class="thumbnail img-responsive" data-original-title="" title="">
													<img src="img/img-lg-one.jpg" alt="User">
												</a>
											</div>
											<div class="col-md-2 col-sm-2 col-xs-4">
												<a href="#" class="thumbnail img-responsive" data-original-title="" title="">
													<img src="img/img-lg-two.jpg" alt="User">
												</a>
											</div>
											<div class="col-md-2 col-sm-2 col-xs-4">
												<a href="#" class="thumbnail img-responsive" data-original-title="" title="">
													<img src="img/img-lg-three.jpg" alt="User">
												</a>
											</div>
											<div class="col-md-2 col-sm-2 col-xs-4">
												<a href="#" class="thumbnail img-responsive" data-original-title="" title="">
													<img src="img/img-lg-four.jpg" alt="User">
												</a>
											</div>
											<div class="col-md-2 col-sm-2 col-xs-4">
												<a href="#" class="thumbnail img-responsive" data-original-title="" title="">
													<img src="img/img-lg-five.jpg" alt="User">
												</a>
											</div>
											<div class="col-md-2 col-sm-2 col-xs-4">
												<a href="#" class="thumbnail img-responsive" data-original-title="" title="">
													<img src="img/img-lg-six.jpg" alt="User">
												</a>
											</div>					
										</div>
										<!-- Row ends -->
								...
								<div class="panel">
									...
									<div class="panel-body">
										...
										<div class="row">
											<div class="col-md-2 col-sm-2 col-xs-4">
												<a href="#" class="thumbnail img-responsive" data-original-title="" title="">
													<img src="img/admin1.png" alt="User" class="img-circle">
												</a>
											</div>
											<div class="col-md-2 col-sm-2 col-xs-4">
												<a href="#" class="thumbnail img-responsive" data-original-title="" title="">
													<img src="img/admin2.png" alt="User" class="img-circle">
												</a>
											</div>
											<div class="col-md-2 col-sm-2 col-xs-4">
												<a href="#" class="thumbnail img-responsive" data-original-title="" title="">
													<img src="img/admin3.png" alt="User" class="img-circle">
												</a>
											</div>
											<div class="col-md-2 col-sm-2 col-xs-4">
												<a href="#" class="thumbnail img-responsive" data-original-title="" title="">
													<img src="img/admin4.png" alt="User" class="img-circle">
												</a>
											</div>
											<div class="col-md-2 col-sm-2 col-xs-4">
												<a href="#" class="thumbnail img-responsive" data-original-title="" title="">
													<img src="img/admin5.png" alt="User" class="img-circle">
												</a>
											</div>
											<div class="col-md-2 col-sm-2 col-xs-4">
												<a href="#" class="thumbnail img-responsive" data-original-title="" title="">
													<img src="img/admin6.png" alt="User" class="img-circle">
												</a>
											</div>					
										</div>
										<!-- Row ends -->
...
<!-- Mirrored from jesus.gallery/cloud2/gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Aug 2015 12:11:45 GMT -->
</html>